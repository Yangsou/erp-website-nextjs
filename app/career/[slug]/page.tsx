  ...
  return (
    <div className="">
      <div className="relative z-10 pt-16 text-[#202222]">
        ...
        <div className="flex bg-[url('/career/bg-gradient.png')] bg-cover bg-center bg-no-repeat p-8">
          <div className="mx-auto flex w-full max-w-6xl gap-6">
            <div className="mr-6 w-[calc(100%_-_296px_-_24px)] bg-white">
              <div className="bg-white p-8">
                <BlocksRenderer content={job?.description ?? []} />
              </div>
              <div className="bg-[#F7F9FD] p-8">
