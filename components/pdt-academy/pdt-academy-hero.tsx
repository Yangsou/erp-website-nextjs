    ...
    <div className="relative min-h-screen w-full">
      ...
      <div className="container relative px-4 py-12 sm:px-6 md:px-8 md:py-16 lg:p-[120px]">
        <div className="flex w-full flex-col justify-center lg:w-[55%] lg:max-w-[548px]">
          ...
          >
            <span className="text-xs font-normal leading-relaxed text-white sm:text-sm sm:leading-relaxed lg:text-base lg:leading-normal">
              Ai+Di cam kết chi phí minh bạch và lộ trình thực chiến, giúp bạn làm chủ ngân sách
              cùng thời gian ngay từ đầu, đồng thời loại bỏ những bất ngờ về chi phí hay rủi ro vận
              hành thường gặp khi tự phát triển nội bộ.
            </span>
          </motion.p>
